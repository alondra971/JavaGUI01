 ...
 * @author Parisan
 */
public class fromPersona extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fromPersona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
